...
const AboutMe = () => {
    return (
        ...
        <p>Robert built user analytics and product recommendation features for a founder in his network at <a href="https://www.allkind.inc/">Allkind</a>. These features resulted in an 11% sales increase in the first month. This inspired his own personal recommendation project, <a href="/welcome-flavor">Flavor Buddy</a>.</p>
